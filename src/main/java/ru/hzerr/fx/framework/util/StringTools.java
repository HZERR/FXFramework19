...
public final class StringTools {
     ...
     */
    public static String uriDecode(String source, @NonNull Charset charset) {
    ...
    public static String[] concatenateStringArrays(@Nullable String[] array1, @Nullable String[] array2) {
        if (ObjectTools.isEmpty(array1)) {
            return array2;
        }
        if (ObjectTools.isEmpty(array2)) {
            return array1;
        }
